...
export default function Hero() {
  return (
    <section className="relative h-[90vh] min-h-[640px] w-full overflow-hidden rounded-b-3xl bg-slate-950 text-white">
      {/* 3D Background */}
      ...
      <div className="relative mx-auto flex h-full max-w-7xl flex-col items-center justify-center px-6 text-center">
        ...
        <h1 className="mx-auto max-w-5xl text-4xl font-semibold leading-tight tracking-tight sm:text-5xl md:text-6xl">
